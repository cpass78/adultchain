...
#ifndef ADULTCHAIN_WALLET_WALLET_H
#define ADULTCHAIN_WALLET_WALLET_H
...
public:
     ...
     * on this adultchain node, and set to 0 for transactions that were created
...
#endif // ADULTCHAIN_WALLET_WALLET_H
