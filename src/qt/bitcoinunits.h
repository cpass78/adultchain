...
#ifndef ADULTCHAIN_QT_ADULTCHAINUNITS_H
#define ADULTCHAIN_QT_ADULTCHAINUNITS_H
...
*/
class AdultChainUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AdultChainUnits(QObject *parent);
...
typedef AdultChainUnits::Unit AdultChainUnit;

#endif // ADULTCHAIN_QT_ADULTCHAINUNITS_H
