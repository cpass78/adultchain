    ...
    mapper(0)
{
    ...
    ui->adultchainAtStartup->setToolTip(ui->adultchainAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->adultchainAtStartup->setText(ui->adultchainAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openAdultChainConfButton->setToolTip(ui->openAdultChainConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new AdultChainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->adultchainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAdultChainConfButton_clicked()
{
