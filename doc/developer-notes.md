...
- Use include guards to avoid the problem of double inclusion. The header file
  `foo/bar.h` should use the include guard identifier `ADULTCHAIN_FOO_BAR_H`, e.g.

```c++
#ifndef ADULTCHAIN_FOO_BAR_H
#define ADULTCHAIN_FOO_BAR_H
...
#endif // ADULTCHAIN_FOO_BAR_H
```
